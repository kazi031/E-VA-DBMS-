...
<body>
  ...
  <header>
   <div class="container">
        ...
        <div class="dropdown">
          <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Type of Employee
          <span class="float-right"></span></button>
          <ul class="dropdown-menu">
            <li><a href="AP_communityworker.php">Community Worker</a></li>
            <li><a href="AP_employee.php">Employee</a></li>
            <li><a href="AP_scrapdealer.php">Scrap Dealer</a></li>
          </ul>
      </div>
    </div>
   </div>
