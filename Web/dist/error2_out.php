            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Error Resolve</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="Home.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Error Resolve</li>
                        </ol>
                  
                        <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-table mr-1"></i>Error Cost Table</div>
                            <div class="card-body">
...
<?php
$sql= "select * from error order by error_id" ;
