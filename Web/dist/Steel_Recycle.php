                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav"><a class="nav-link" href="layout-static.html">Insert Process</a></nav>
                            </div>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Steel Recycle Process</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                            <li class="breadcrumb-item active">Steel Recycle</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
...
<div  class="container">
  ...
  <form lass="was-validated" method="post">
    <div class="form-group"> 
      ...
      <input type="number" min="0"  step="any" class="form-control" id="uname" name="steel_amount" required>
      
	  <label for="uname">Iron Amount (in Kg)</label>
      <input type="number" min="0"  step="any" class="form-control" id="uname" name="iron_amount" required>
      </div>
    <br>
