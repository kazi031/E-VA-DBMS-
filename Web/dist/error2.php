...
else
{
  ...
  if(isset($_POST['type']))
  {
    if(!empty($_POST['type']))
    {
      ...
      $type=$_POST['type'];
      $solving_cost=$_POST['solving_cost'];
      


      $sql='INSERT INTO error(error_id ,type ,solving_cost) VALUES(error_error_id_seq.nextval,:type,:solving_cost)';
  ...
  oci_bind_by_name($compiled,':solving_cost',$solving_cost);
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Error Entry</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="Home.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Error Cost</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
...
<div  class="container">
  <br><br>
  <h2>Enter Error Cost Information : <h2>
  <br><br>
  <form action="Process_Insert_2.php" lass="was-validated" method="post">
    <div class="form-group">
	
      <label for="uname">Type</label>
      <input type="text" class="form-control" id="uname" placeholder="Type" name="type" required>
      <label for="uname">Solving Cost</label>
      <input type="text" class="form-control" id="uname" placeholder="Solving Cost" name="solving_cost" required>
